...
# Which __init__ methods are invoked and in which order is determined by the coding 
# of the individual __init__ methods.
# When resolving a reference to an attribute of an object that's an 
# instance of class D, Python first searches the object's instance variables 
